...
int main() 
{
  ...
  cout << x << endl;
  fout << "popRearx3 value: " << x << endl; //prints out x to the outfile
  // 47
  ...
  // [9, 11, 25, 33, 47, 51, 63]
  cout << x << endl;
  fout << "popAt value 3 index: " << x << endl;
  // 27

  //looks for the value 51 in the vector v2 and saves the index in int x
  x = v2.find(51);
  cout << x << endl;
  fout << "Index where the value was located: " << x << endl; // prints out the index of where 51 is stored
  // 5

  //looks for the value 99 in the vector v2 and saves the index in int x
  x = v2.find(99);
  cout << x << endl;
  fout << "Index where the value was located: " << x << endl; //prints out -1 because the item was not found
  // -1
